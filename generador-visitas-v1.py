...
# Ajustar las visitas para que la persona vuelva a Buenos Aires cada día
def adjust_itinerary(itinerary):
    adjusted_itinerary = []
    for week in itinerary:
        adjusted_week = []
        for day in week:
            adjusted_day = [0] + day + [0]  # Añadir Capital Federal al inicio y al final de cada día
            adjusted_week.append(adjusted_day)
